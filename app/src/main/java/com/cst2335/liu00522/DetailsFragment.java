...
public class DetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        String content = dataFromActivity.getString("Message");
        View result = inflater.inflate(R.layout.fragment_details, container, false);

        // Message
        TextView messageView = result.findViewById(R.id.messageHere);
        ...
        // checkBox
        CheckBox cbVIew = result.findViewById(R.id.checkbox);
        if (dataFromActivity.getInt("Type") == 1) {
